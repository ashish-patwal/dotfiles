...
user = {
  ...
  music_client = "kitty -o font_size=12 -o font_family=JetBrainsMono --class music -e ncmpcpp",
  ...
  -- >> User profile <<
  profile_picture = os.getenv("HOME") .. "/.config/awesome/Shinchan.jpg",
  ...
  openweathermap_key = "6378f4931e5c41412015c4adaae96cbf",
  openweathermap_city_id = "1258044",
