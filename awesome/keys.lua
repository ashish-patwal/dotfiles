...
-- Focus client by direction (hjkl keys)
  ...
  -- Media keys
  awful.key({ superkey, altkey }, "period", function() awful.spawn.with_shell("playerctl --player spotify next") end,
    { description = "next song", group = "media" }),
  awful.key({ superkey, altkey }, "comma", function() awful.spawn.with_shell("playerctl --player spotify previous") end,
    { description = "previous song", group = "media" }),
  awful.key({ superkey, altkey }, "space", function() awful.spawn.with_shell("playerctl --player spotify play-pause") end
    ,
  ...
  -- awful.key({ superkey }, "=", function () music_sidebar_toggle() end,
  --     {description = "show or hide music-sidebar", group = "awesome"}),
  -- Toggle wibar(s)
  ...
  awful.key({ superkey, shiftkey }, "period", function() machi.default_editor.start_interactive() end,
    { description = "machi: edit the current machi layout", group = "layout" }),
  awful.key({ superkey, shiftkey }, "slash", function() machi.switcher.start(client.focus) end,
