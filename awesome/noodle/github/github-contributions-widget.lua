...
local widget_themes = require("noodle.github.themes")
...
local function worker(user_args)
  ...
  local username = args.username or 'ashish-patwal'
  local days = args.days or 365
  -- local color_of_empty_cells = args.color_of_empty_cells or '#1A2026'
  local color_of_empty_cells = args.color_of_empty_cells or '#0C0F15'
  ...
  local function get_square(color)
    ...
    return wibox.widget {
      ...
      draw = function(_, _, cr, _, _)
        ...
        cr:rectangle(0, 0, with_border and 5 or 6, with_border and 5 or 6)
        cr:fill()
      end,
